...
@ConfigurationProperties(prefix = "roady.ai.image-analysis")
public class AiImageAnalysisProperties {

    private String endpointUrl;
    private boolean workerEnabled;
    private String queueKey = "roady:damage:image-analysis:queue";
    private String deadLetterQueueKey = "roady:damage:image-analysis:dead-letter";
