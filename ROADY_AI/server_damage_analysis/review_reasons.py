...
REVIEW_MESSAGES = {
    "ROI_DAMAGE_FALLBACK_USED": "점자블록 탐지 영역을 찾지 못해 파손 후보 영역을 대신 사용했습니다.",
    "FRAME_QUALITY_NOT_VERIFIED": "대표 프레임이 품질 검증 조건을 충족하지 못했습니다.",
    "TACTILE_BLOCK_NOT_DETECTED": "점자블록 영역이 탐지되지 않았습니다.",
    "BLOCK_INSTANCE_UNRESOLVED": "점자블록이 개별 블록으로 분리되지 않아 블록 그룹 단위로 분석했습니다.",
    ...
    "RATIO_NEAR_THRESHOLD": "파손 비율이 심각도 등급 경계에 가까워 확인이 필요합니다.",
