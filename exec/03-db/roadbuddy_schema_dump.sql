-- Roady / Roadbuddy DB schema dump
-- Generated from Roady_BE/src/main/resources/rdb/schema.sql
-- Scope: current schema (structure-only). Binary sample images and runtime data are not embedded.
--
-- For demo data, start Spring with:
--   ROADY_DEFAULT_USERS_ENABLED=true
--   ROADY_SAMPLE_DATA_ENABLED=true
-- UserDataInitializer and SampleDataInitializer then insert idempotent demo accounts and rows.

CREATE DATABASE IF NOT EXISTS roadbuddy
