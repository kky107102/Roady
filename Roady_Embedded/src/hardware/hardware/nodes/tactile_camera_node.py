...
class TactileCameraNode(Node):
    """Publishes BRIO frames for line tracing and damage detection."""
    ...
    def __init__(self):
        ...
        self.declare_parameter("frame_id", "tactile_camera")
        self.declare_parameter("topic", "/camera/tactile/image_raw")
